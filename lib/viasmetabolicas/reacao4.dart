...
import 'package:app_bioquimica/viasmetabolicas/reacao5.dart';
import 'package:flutter/material.dart';

// ignore: use_key_in_widget_constructors
class Reacao4 extends StatelessWidget {
  @override
                ...
                ElevatedButton(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('1,3-Bifosfoglicerato e\n Di-hidroxiacetonafosfato',
                          style: TextStyle(color: Colors.black, fontSize: 10)),
                      const SizedBox(
                        height: 10,
                      ),
                      Image.asset(
                        'assets/images/duaserradas.png',
                        width: 80,
                        height: 80,
                      ),
                      const SizedBox(
                ...
                */
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    await Navigator.of(context).push(
                      CustomPageRoute(exitPage: this, enterPage: Reacao5()),
                    );
                  },
                  style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(Colors.white)),
                  child: Column(
                    children: [
                      ...
                      Text('Gliceraldeido-3-fosfato e \nDi-hidroxiacetonafosfato',
                          style: TextStyle(color: Colors.black, fontSize: 10)),
                      const SizedBox(
                        height: 10,
                      ),
                      Image.asset(
                        'assets/images/duascertas.png',
                        width: 80,
                        height: 80,
                      ),
                      const SizedBox(
