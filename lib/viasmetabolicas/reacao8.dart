...
import 'package:app_bioquimica/viasmetabolicas/reacao9.dart';
import 'package:flutter/material.dart';

// ignore: use_key_in_widget_constructors
class Reacao8 extends StatelessWidget {
  @override
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    await Navigator.of(context).push(
                      CustomPageRoute(exitPage: this, enterPage: Reacao9()),
                    );
                  },
                  style: ButtonStyle(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('2-fosfoglicerato',
                          style: TextStyle(color: Colors.black, fontSize: 10)),
                      const SizedBox(
                        height: 10,
                      ),
                      Image.asset(
                        'assets/images/2fosfoglicerato.png',
                        width: 80,
                        height: 80,
                      ),
                      const SizedBox(
